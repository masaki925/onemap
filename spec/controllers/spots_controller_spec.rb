  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved spot as @spot" do
        ...
        post :create, {:spot => { "name" => "invalid value" }}, valid_session
        assigns(:spot).should be_a_new(Spot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested spot" do
        ...
        Spot.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => spot.to_param, :spot => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the spot as @spot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Spot.any_instance.stub(:save).and_return(false)
        put :update, {:id => spot.to_param, :spot => { "name" => "invalid value" }}, valid_session
        assigns(:spot).should eq(spot)
      end
